  ...
  */
  ...
  _rebuildMask() {
    ...
    for (let i = 0; i < pattern.length; ++i) {
      ...
      const def = isInput ? new _pattern_input_definition_js__WEBPACK_IMPORTED_MODULE_4__["default"]({
        parent: this,
        lazy: this.lazy,
        eager: this.eager,
        placeholderChar: this.placeholderChar,
...
class PatternInputDefinition {
  ...
  constructor(opts) {
    const {
      ...
      blockOpts = Object(_rollupPluginBabelHelpers_6b3bd404_js__WEBPACK_IMPORTED_MODULE_0__["_"])(opts, _excluded);
...
var modalPhone = document.querySelector('#modal-tel');
var feedbackPhone = document.querySelector('#feedback-tel');
var validateInputPhone = function validateInputPhone() {
  Object(_creates_mask_phone__WEBPACK_IMPORTED_MODULE_0__["createsMaskPhone"])(modalPhone);
